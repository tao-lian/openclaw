...
# Trivy Scan Report
**Date:** 2026-04-07 08:12:50.3962291 +0000 UTC m=+46.069605456
...
| [CVE-2026-39363](https://avd.aquasec.com/nvd/cve-2026-39363) | 🟠 **HIGH** | `vite` | 8.0.5, 7.3.2, 6.4.2 | Vite Vulnerable to Arbitrary File Read via Vite Dev Server WebSocket |
| [GHSA-v2wj-q39q-566r](https://github.com/advisories/GHSA-v2wj-q39q-566r) | 🟠 **HIGH** | `vite` | 8.0.5, 7.3.2 | Vite: `server.fs.deny` bypassed with queries |
| [GHSA-4w7w-66w2-5vf9](https://github.com/advisories/GHSA-4w7w-66w2-5vf9) | 🟡 **MEDIUM** | `vite` | 8.0.5, 7.3.2, 6.4.2 | Vite Vulnerable to Path Traversal in Optimized Deps `.map` Handling |
