...
# Trivy Scan Report
**Date:** 2026-04-08 08:12:47.134749742 +0000 UTC m=+36.221496847
...
| [CVE-2026-39407](https://avd.aquasec.com/nvd/cve-2026-39407) | 🟡 **MEDIUM** | `hono` | 4.12.12 | Hono: Middleware bypass via repeated slashes in serveStatic |
| [CVE-2026-39408](https://avd.aquasec.com/nvd/cve-2026-39408) | 🟡 **MEDIUM** | `hono` | 4.12.12 | Hono: Path traversal in toSSG() allows writing files outside the output directory |
| [CVE-2026-39409](https://avd.aquasec.com/nvd/cve-2026-39409) | 🟡 **MEDIUM** | `hono` | 4.12.12 | Hono has incorrect IP matching in ipRestriction() for IPv4-mapped IPv6 addresses |
| [CVE-2026-39410](https://avd.aquasec.com/nvd/cve-2026-39410) | 🟡 **MEDIUM** | `hono` | 4.12.12 | Hono: Non-breaking space prefix bypass in cookie name handling in getCookie() |
| [GHSA-26pp-8wgv-hjvm](https://github.com/advisories/GHSA-26pp-8wgv-hjvm) | 🟡 **MEDIUM** | `hono` | 4.12.12 | Hono missing validation of cookie name on write path in setCookie() |
